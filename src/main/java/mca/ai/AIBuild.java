...
public class AIBuild extends AbstractToggleAI
{
				...
				for (int i = 0; i < 10; i++)
				{
					...
					if (index >= blockPoints.size())
					{
						for (Point3D point : torchPoints)
						{
							...
							BlockPosHelper.setBlock(owner.worldObj, origin.iPosX + point.iPosX, origin.iPosY + point.iPosY, origin.iPosZ + point.iPosZ, blockObj.getBlock(), blockObj.getMeta());
						}
					...
					else
					{
						...
						{
							BlockPosHelper.setBlock(owner.worldObj, origin.iPosX + point.iPosX, origin.iPosY + point.iPosY, origin.iPosZ + point.iPosZ, groundBlock, 0);							
						}
	...
	private void primeSchematic(String schematicLocation)
	{
		...
		for (final Map.Entry<Point3D, BlockObj> entry: schematicMap.entrySet())
		{
			...
			Block blockAtPoint = BlockPosHelper.getBlock(owner.worldObj, origin.iPosX + point.iPosX, origin.iPosY + point.iPosY, origin.iPosZ + point.iPosZ);
			...
			{
				BlockPosHelper.setBlock(owner.worldObj, origin.iPosX + point.iPosX, origin.iPosY + point.iPosY, origin.iPosZ + point.iPosZ, Blocks.air);
			}
